...
const Footer = () => {
  return (
    <div>
      <footer className="footer bg-cyan-700 text-center justify-center gap-80 text-white text-sm  p-10">
  <nav>
...
<footer className="footer bg-cyan-700 text-base-content border-base-300 border-t px-10 py-4">
  <aside className="grid-flow-col items-center">
  <img className='w-28' src={logo} alt="" />
    <p className='text-white font-bold text-sm'>
    © 2023 All right reserved by SurgicalSavvy
      <br />
