...
const Best = () => {
    return (
        <div className='pt-10 pb-8 shadow-2xl'>
            <div className='text-center py-6 '>
            <p className='text-4xl font-bold text-cyan-900 '>Get Know About Us</p>
            ...
            <div className="card w-96 bg-cyan-900 shadow-xl">
                 <div className="card-body text-center">
                     <h2 className="card-title justify-center"><FaAudible size='3rem'/></h2>
        ...
        <div className="card w-96 bg-cyan-900 shadow-xl">
                 <div className="card-body text-center">
                     <h2 className="card-title justify-center"><FaShippingFast size='3rem'/></h2>
        ...
        <div className="card w-96 bg-cyan-900 shadow-xl">
                 <div className="card-body text-center">
                     <h2 className="card-title justify-center"><IoIosPeople size='3rem'/></h2>
        ...
        <div className="card w-96 bg-cyan-900 shadow-xl">
                 <div className="card-body text-center">
                     <h2 className="card-title justify-center"><FaRetweet size='3rem'/></h2>
